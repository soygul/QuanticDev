...
const calculatedSolution0 = climbStairsFibonacci(stairs0, maxSteps0)
...
console.log(`Example Stairs #0: ${stairs0}, maxSteps: ${m0}, Solution: ${solution0}`)
...
const calculatedSolution1 = climbStairsFibonacci(stairs1, maxSteps1)
...
console.log(`Example Stairs #1: ${stairs1}, maxSteps: ${m1}, Solution: ${solution1}`)
...
const calculatedSolution2 = climbStairsFibonacci(stairs2, maxSteps2)
...
console.log(`Example Stairs #2: ${stairs2}, maxSteps: ${m2}, Solution: ${solution2}`)
...
const calculatedSolution3 = climbStairsFibonacci(stairs3, maxSteps3)
...
console.log(`Example Stairs #3: ${stairs3}, maxSteps: ${m3}, Solution: ${solution3}`)
...
const calculatedSolution4 = climbStairsFibonacci(stairs4, maxSteps4)
...
console.log(`Example Stairs #4: ${stairs4}, maxSteps: ${m4}, Solution: ${solution4}`)
...
const calculatedSolution5 = climbStairsFibonacci(stairs5, maxSteps5)
...
console.log(`Example Stairs #5: ${stairs5}, maxSteps: ${m5}, Solution: ${solution5}`)
...
const calculatedSolution6 = climbStairsFibonacci(stairs6, maxSteps6)
...
console.log(`Example Stairs #6: ${stairs6}, maxSteps: ${m6}, Solution: ${solution6}`)

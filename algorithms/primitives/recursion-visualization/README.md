...
The video has all of the illustrations along with the narrative. If you want to read the comments or leave a comment, do so under the YouTube video. If you want to contribute to the article, make a pull request on GitHub.
...
## Overview
Hi, I am QuanticDev, and today we will visualize recursion. You are currently watching the visualization of the recursive calculation of 10th Fibonacci number, with a recursion depth of 10. As you see, the visualization of our recursion branches like a tree. The rate of change of this tree's width represents the time complexity of our recursive calculation. We will investigate this in a moment. The height of this recursion tree is the depth of our function call stack.

Now let's have a look at a more straightforward example to see more details.

## Power Function
What you see is the visualization of a "2 to the power of n" function which is implemented using recursion. The code is simple:

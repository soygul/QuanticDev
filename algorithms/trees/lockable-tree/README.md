...
* Solution code to examples are available on: [•	https://github.com/soygul/QuanticDev/tree/master/algorithms/trees/lockable-tree.js](•	https://github.com/soygul/QuanticDev/tree/master/algorithms/trees/lockable-tree.js){:target="_blank"}
